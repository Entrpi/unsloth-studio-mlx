    ...
    try:
        ...
        if (
            ...
            return LoadResponse(
                ...
                is_gguf = False,
                is_mlx = True,
                hf_variant = mlx_backend.hf_variant,
        ...
        if config.is_mlx_vlm:
            ...
            return LoadResponse(
                ...
                is_mlx_vlm = True,
                is_mlx_lora = False,
                hf_variant = mlx_vlm_backend.hf_variant,
                is_audio = False,
                audio_type = None,
...
async def anthropic_messages(
    ...
    # the `not image_b64` gate in /v1/chat/completions) — merged in from
    # upstream #5128 while preserving the MLX+GGUF generalisation of
    # `active_backend` we added for MLX tool-calling.
